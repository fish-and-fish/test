...
public class Expression {
    ...
    public static void main(String[] args) throws Exception {
        ...
        params.put("ImageURL", "http://viapi-test.oss-cn-shanghai.aliyuncs.com/viapi-3.0domepic/facebody/RecognizeExpression/RecognizeExpression10.jpg");
        // API Action，能力名称，请参考具体算法文档详情页中的Action参数，这里以图像超分为例：https://help.aliyun.com/document_detail/151947.html
        String action = "RecognizeExpression";
